<template>
  <q-dialog v-model="localIsOpen">
    <q-card-section>
      <div class="text-h6">Messages & Collaboration</div>
    </q-card-section>
    ...
    <q-layout view="lHh Lpr lFf" class="WAL__layout shadow-3">
      ...
      <q-drawer v-model="leftDrawerOpen" show-if-above bordered :breakpoint="690">
        <q-toolbar class="bg-grey-3">
          ...
          <q-btn round flat icon="close" @click="localIsOpen = false" />
        </q-toolbar>
      ...
      <q-footer>
        <q-toolbar class="bg-grey-3 text-black row">
          ...
          />
          <q-btn round flat icon="send" color="green" @click="sendMessage" />
        </q-toolbar>
      </q-footer>
    </q-layout>
  </q-dialog>
